...
import NewLoanModal from '../modals/NewLoanModal/NewLoanModal';
                      ...
                      <td className="claims-action-cell">
                        ...
                        {dropdownOpenFor === loan.id && (
                          ...
                          >
                            ...
                            >
                              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><circle cx="11.5" cy="13.5" r="3" /><line x1="13.62" y1="15.62" x2="17" y2="19" /></svg>
                              View Details
                            </button>
                            <button
                              type="button"
                            ...
                            >
                              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M17 3a2.85 2.82 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z" /><path d="m15 5 3 3" /></svg>
                              Edit
                            </button>
