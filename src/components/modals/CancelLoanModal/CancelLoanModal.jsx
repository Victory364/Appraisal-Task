...
import successIllustration from '../../../assets/Fowgate Folder/cancel-circle.svg';
    ...
    <div className="modal-overlay">
      {cancelStatus === 'confirm' ? (
        ...
        <div className="cancel-success-modal">
          <img src={successIllustration} alt="Application Cancelled" className="cancel-success-illustration" />
